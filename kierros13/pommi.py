...
class Pommikäyttöliittymä:
    def __init__(self):
        ...
        self.__pommi_label = Label(self.__pääikkuna, text="")

        self.__räjäytä_button = Button(self.__pääikkuna, image=self.__bang_kuva,
                                       command=self.räjäytä)
        self.__lataa_button = Button(self.__pääikkuna, text="lataa",
                                     command=self.lataa, state=DISABLED,
                                     background="white")
        self.__lopeta_button = Button(self.__pääikkuna, text="lopeta",
