...
def main():
    ...
    murtoluvut = {}
    operands = {"+": lambda frac1, frac2: frac1.add(frac2),
    ...
    while True:
        ...
        if rivi == "quit":
            ...
            if name1 and name2 in murtoluvut:
                frac1 = murtoluvut[name1]
                frac2 = murtoluvut[name2]
                result_old = operands[operand](frac1, frac2)
                result = operands[operand](frac1, frac2).return_string()

                print(f"{frac1} {operand} {frac2} = {result}")
                result_old.simplify()
                print(f"simplified {result_old}")
